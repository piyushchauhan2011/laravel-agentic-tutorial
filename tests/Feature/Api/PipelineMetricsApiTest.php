...
class PipelineMetricsApiTest extends TestCase
{
    use RefreshDatabase;

    public function test_pipeline_metrics_endpoint_returns_funnel_counts(): void
    {
        ...
        $this->getJson('/api/v1/metrics/pipeline')
            ->assertOk()
